...
Im1 = float(input("What is the normalized intensity measured at GPS1 above the snowpack?\n"))
Im23 = float(input("What is the normalized mean intensity of GPS2 and GPS3 below the snowpack?\n"))
